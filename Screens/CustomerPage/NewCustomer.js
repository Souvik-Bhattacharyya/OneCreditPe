        ...
        <>
            <View style={styles.container}>
                ...
                <View style={styles.Row}>
                    <View style={{ marginTop: 15, borderRadius: 10, }} >
                        <View style={{ flexDirection: 'row' }}>
                            <Text style={{ color: '#20409a', fontSize: 20, fontWeight: '700', paddingTop: 20 }}>
                                Old Customers
                            </Text>
                        </View>
                        ...
                        <TouchableOpacity style={styles.contactBox}>
                            <View style={{ width: 42, height: 42, backgroundColor: '#c3e2ff', justifyContent: 'center', alignItems: 'center', borderRadius: 4 }}>
                                <Text style={{ fontSize: 28, fontWeight: '700', color: '#20409a' }}>A</Text>
                            </View>
                ...
                <View style={{
                    ...
                    <TouchableOpacity
                        style={{ backgroundColor: "#20409a", flexDirection: 'row', alignItems: 'center', paddingVertical: 10, paddingLeft: 10, paddingRight: 20, borderRadius: 50, justifyContent: 'flex-end' }}>
                        <View style={{ width: 32, height: 32, borderRadius: 20, backgroundColor: '#fff', justifyContent: 'center', alignItems: 'center', marginHorizontal: 10 }}>
                            <AntDesign name="plus" color={'#20409a'} size={22} />
                        </View>
                        <Text style={{ fontSize: 18, fontWeight: '600', color: '#fff' }}>Add From Contact</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </>
