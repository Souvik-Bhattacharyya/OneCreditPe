...
// //       body: "PICKUP LOCATION > DESTINATION > REQUEST BB > BOOKED (NOTIFIED WHEN ACCEPTED BY PILOT)",
// //       expanded: false,
// //     },
// //   ]);
...
// //     faqs.forEach(faq => {
// //       if (faq.id === id) faq.expanded = !faq.expanded;
// //       else faq.expanded = false;
// //     });
// //     setFaqs([...faqs]);
// //   };

// //   const Item = ({id, title, body, expanded}) => {
// //     return (
...
// //           expanded={expanded}
// //           sectionHeader={
// //             <Text style={{fontWeight: "500", color: "#000", marginBottom: 10}}>
// //               {title}
// //             </Text>
// //           }
// //           onPress={() => expandSection(id)}>
// //           <Text>{body}</Text>
// //         </ExpandableSection>
// //       </View>
// //     );
...
// //   return (
// //     // <CustomHeader pageName={"FAQs"} navigation={navigation}>
